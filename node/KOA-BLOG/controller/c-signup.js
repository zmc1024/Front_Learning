const userModule = require('../lib/mysql.js')
const md5 = require('md5')
const fs = require('fs')

exports.postSignup = async ctx => {
  // console.log(ctx.request.body);   //已经拿到了浏览器传的参数
  // 调用数据库插入的方法
  ...
  if(upload){
    await userModule.insertData([name, md5(password), getName + '.png', new Date().getTime()])
      .then(res => {
